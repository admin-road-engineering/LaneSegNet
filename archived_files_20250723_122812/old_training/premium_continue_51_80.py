...
def premium_gpu_training(learning_rate=0.001, dice_weight=0.6):
    ...
    for epoch in range(50, 80):  # Continue from epoch 50 to 80  # More epochs for convergence
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Option 1: Premium Training Continuation (Epochs 51-80)')
