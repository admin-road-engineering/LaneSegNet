#!/usr/bin/env python3
"""
Quick Fine-Tuning - Option 3
Using proven architecture from 85.1% mIoU model
Conservative fine-tuning for 85.5-86.0% target
"""
...
def premium_gpu_training(learning_rate=0.001, dice_weight=0.6):
    ...
    for epoch in range(50):  # More epochs for convergence
